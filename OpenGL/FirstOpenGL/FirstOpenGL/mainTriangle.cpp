...
int main()
{
	...
	Shader depthTextureShader("depthTexture_vs.glsl", "depthTexture_fs.glsl");
	...
	depthTextureShader.setInt("depthMap", 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		depthTextureShader.use();
		depthTextureShader.setFloat("near_plane", near_plane);
		depthTextureShader.setFloat("far_plane", far_plane);
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, depthMap);
		//renderQuad();
